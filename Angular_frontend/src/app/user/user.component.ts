...
export class UserComponent implements OnInit {
  ...
  display() {
    var self = this
    this.httpService.get('http://localhost:8082/User/get/' + this.form.data.id, function (res: any) {
      console.log(res)
  ...
  save() {
    var self = this
    this.httpService.post('http://localhost:8082/User/save', this.form.data, function (res: any) {
      console.log('res => ', res)
